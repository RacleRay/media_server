...
class MediaSession {
  ...
  public:
    ...
    [[nodiscard]] std::string name() const { return mSessionName; }
    ...
    bool
    addRtpInstance(MediaSession::TrackId trackId, RtpInstance *rtpInstance);
    ...
    [[nodiscard]] std::string getMulticastDestAddr() const {
  ...
  private:
    ...
    // private callbacks
    static void sendPacketCallback(void* sess_p, void* track_p, void* packet,Sink::PacketType packetType);
